...
namespace HospitalManagement.API.Migrations
{
    ...
    [Migration("20250516100122_Added Messages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagement.API.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HospitalManagement.API.Models.Message", b =>
                {
                    b.HasOne("HospitalManagement.API.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("HospitalManagement.API.Models.ApplicationUser", "Sender")
                        .WithMany()
